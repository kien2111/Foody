...
/**
 * Created by nhox_ on 8/4/2017.
 */

public class ChonTinhThanh_Activity extends AppCompatActivity {
    ListView lv;
    TextView tv;
    ImageButton imgbtn;
    DbAdapter dbAdapter=null;

    public MyArrayAdapter myArrayAdapter;
    /////////////
    // input:
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        CallRestTaskgetList task = new CallRestTaskgetList();
        myArrayAdapter = new MyArrayAdapter(this, R.layout.item_listview_layout,createListItem( dbAdapter.getTinhThanhForChonTinhThanhActivity()),
                GlobalVariable.oldpositionchontinhthanhactivityclick,2);
        lv.setAdapter(myArrayAdapter);
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                GlobalVariable.oldpositionchontinhthanhactivityclick=position;
        ...
        tv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(nameofcity!=null){
                    ...
                    intent.putExtra("nameofcity",nameofcity);
                    setResult(RESULT_OK, intent);
                    GlobalVariable.currentcityid = tagofcurrentcityid;
                    GlobalVariable.currentdistid=null;
                    GlobalVariable.currentstreetid = -1;
                    finish();
                }else{
